<?php
    ...
    $PDO = db_connect();
    $sql = "SELECT L.id, L.titulo, L.autor, L.sessao_id, S.descricao FROM livro as L INNER JOIN sessao as S on L.sessao_id = S.id ORDER BY L.titulo ASC";
...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="container">
            <div class="jumbotron">
                <p class="h3 text-center">Livros cadastrados</p>
            </div>
